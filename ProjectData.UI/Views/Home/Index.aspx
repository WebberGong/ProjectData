...
<table>
    <tr id="queryCondition" style="height: 35px">
        ...
        <td style="margin-left: 30px; text-align: center; width: 70px;">
            <input id="btnQuery" type="button" onclick="onQuery()" value="查  询" style="height: 22px; width: 60px;"/>
        </td>
        <td style="text-align: left; width: 70px;">
            <input id="btnExport" type="button" onclick="onExport()" value="导  出" style="height: 22px; width: 60px;"/>
        </td>
        <td></td>
    </tr>
    <tr>
